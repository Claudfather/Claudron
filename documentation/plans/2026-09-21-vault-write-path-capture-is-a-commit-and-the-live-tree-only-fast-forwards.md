...
Together these retire the two failure classes above. They do not retire the operational ones — a wedged tree still needs detecting and a stale lock still needs expiring — which is why those ship first as plain fixes.
